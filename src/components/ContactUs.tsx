...
const ContactUs = () => {
  ...
  const handleCellNumber = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Limit the length to 12 characters (4 digits + - + 6 digits)
    if (value.length > 12) {
  ...
  return (
    <>
      <div className="mb-[50px] mx-3 lg:mx-[5%] font-poppins">
        <div className="font-bebas flex flex-col rounded-lg py-8 bg-[rgb(20,20,20)] text-[#ffffff]  shadow-lg items-center gap-[6px] px-2  md:px-8 md:justify-center md:gap-[120px] text-[15px] md:flex-row md:items-start">
            ...
            <form>
              <div className="flex flex-col gap-3">
                <div className="md:flex gap-2">
                  <div>
                    <label className="block font-semibold my-1" htmlFor="name">
                      First Name:
                    </label>
                    <input
                      type="text"
