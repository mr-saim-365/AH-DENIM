...
const ContactUs = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="mb-[5rem] mt-[10rem] flex flex-col gap-8 2xl:flex-row 2xl:justify-between mx-3 2xl:mx-[2%] lg:mx-[5%]">
        <iframe
        ...
        <div className="flex flex-col rounded-lg py-8 bg-gradient-to-br from-gray-700 via-gray-900 to-black text-white shadow-lg items-center gap-[6px] px-2 md:px-8 md:justify-center md:gap-[120px] text-[15px] md:flex-row md:items-start">
          <div className="flex flex-col gap-5 justify-center">
            <h1 className="text-[26px] sm:text-3xl 2xl:text-[40px] font-bold font-Arabic mb-3">
              Contact Us
            </h1>
            ...
            <div className="flex gap-2 items-center border bg-[#ffffff] text-[#222222] text-sm border-gray-200 p-3 rounded-lg">
              ...
              <div className="flex items-center gap-3">
                <div>
                  <FaFacebookF
                    size={35}
                    style={{ color: "black" }}
                    className="bg-[#ffffff] rounded-[50%] p-2 cursor-pointer"
                  />
                </div>
                ...
                <div>
                  <svg
                    ...
                    viewBox="0 0 448 512"
                    className="bg-[#ffffff] rounded-[50%] p-2 w-[35px] h-[35px] cursor-pointer"
                  >
          ...
          <div className="my-5 flex flex-col gap-3 w-[90%] sm:w-[350px] lg:w-[450px]">
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col gap-3">
                ...
                <div>
                  <label className="block font-semibold my-1">Email:</label>
                  <input
                    type="email"
                    value={email}
                ...
                <div>
                  <label className="block font-semibold my-1">Message:</label>
                  <textarea
                    value={message}
