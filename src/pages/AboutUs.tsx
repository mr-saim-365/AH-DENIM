  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="px-8 md:px-20 py-16">
        <h2 className="text-3xl font-bold mb-2 pb-4 text-[#4D4D4D]">
          About Us
        </h2>
        <p className="leading-relaxed text-[16px] md:text-lg">
          About AH Denim At AH Denim, we are more than just manufacturers—we are
          creators, innovators, and problem solvers in the world of denim and
          woven apparel. With over two decades of experience, we specialize in
          producing high-quality, fashion-forward garments that meet the
          evolving needs of global brands. Our Journey What started in 2000 as a
          passion for denim craftsmanship has grown into a state-of-the-art
          manufacturing facility, delivering trend-driven, sustainable apparel
          for men, women, and kids. With a strong reputation in the industry, we
          have proudly been exporting to the UK and Dubai for the last three
          years, helping brands bring their vision to life. What We Offer
          Expertise in Woven & Denim Apparel – From timeless classics to
          contemporary fashion pieces, we manufacture a diverse range of
          garments.Innovative Design & Finishing – Our advanced in-house washing
          and finishing facilities allow us to create unique textures, washes,
          and sustainable finishes.Sustainability at the Core – We embrace
          eco-conscious production, using water-saving technologies and
          responsible sourcing to reduce our environmental footprint. Flexible
          Solutions for Brands – Our low MOQ policy ensures that both emerging
          designers and established labels can access high-quality manufacturing
          without high-volume constraints. Why Choose AH Denim? At AH Denim, we
          don’t just follow trends—we set them. Our commitment to quality,
          innovation, and sustainability ensures that every piece we produce
          meets the highest industry standards. Whether you're a startup looking
          for a reliable partner or an established brand seeking a fresh
          manufacturing perspective, we are here to deliver exceptional results.
        </p>
      </section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-2 gap-6 mt-10text-sm 2xl:w-[80%]">
              <div className="text-black p-6 rounded-lg shadow-lg border">
                ...
                <p className="mt-2  text-justify ">
                  At AH Denim, we actively participate in global trade shows to
                  showcase our expertise in denim innovation and sustainable
                  apparel manufacturing. Recently, we exhibited at Karachi
                  TEXPO, one of Pakistan’s leading textile exhibitions. The
                  event brought together industry leaders, buyers, and fashion
                  brands from around the world to explore our latest collections
                  and innovations.
                </p>
              </div>
              <div className="text-black p-6 rounded-lg shadow-lg border">
              ...
              <div className="text-black p-6 rounded-lg shadow-lg border">
                ...
                <p className="mt-2  text-justify ">
                  ...
                  exploring new collaborations has been a key part of our growth
                  strategy. We remain dedicated to trendsetting and fostering
                  meaningful partnerships in the fashion sector.
                </p>
              </div>
